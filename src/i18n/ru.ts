...
export const ru: Dictionary = {
  ...
  "warn.tooFew":
    "Открыто только {count} из {total} локаций. Сеть реле Valve начинает строить обходные маршруты, и матчи чаще срываются. Рекомендуем оставлять активными хотя бы {min}.",
  ...
  "info.tab.guide": "Инструкция",
  "info.tab.licenses": "Лицензии",
  "info.thirdPartyTitle": "Используемые компоненты",
  "info.thirdPartyBody":
    "Программа построена на библиотеках других авторов, которые сохраняют свои лицензии. Полный список со всеми указаниями авторства и текстами лицензий лежит рядом с программой отдельным файлом.",
  "info.thirdPartyOpen": "Открыть список",
  "info.thirdPartyFailed":
    "Не удалось открыть файл. Он находится в папке установки под именем THIRD-PARTY-LICENSES.md.",
  "info.heading": "О программе server2pick",
  "info.title": "Инструкция",
  "info.close": "Закрыть инструкцию",
  "info.what":
    "Valve направляет матчи не напрямую на сервер, а через relay-локации по всему миру, и подбор матчей сам решает, какая вам достанется. server2pick блокирует реле отдельных локаций в брандмауэре Windows — тогда подбор больше не может отправить вас туда.",
  "info.stepsTitle": "Как пользоваться",
  "info.step1": "Выберите игру слева вверху.",
  "info.step2":
    "Заблокируйте ненужные локации — через список, карту или быстрый выбор. Значения пинга подскажут, что стоит оставить.",
  "info.step3":
    "Нажмите «Применить изменения». Windows один раз запросит права администратора.",
  "info.step4": "Запустите игру. Готово.",
  "info.notesTitle": "Что важно знать",
  "info.note1":
    "Правила находятся в брандмауэре Windows, а не в программе. Они действуют и при закрытом server2pick — пока вы не снимете их здесь.",
  "info.note2":
    "Оставляйте открытыми хотя бы три локации. Если заблокировать слишком много, сеть реле начнёт строить обходные маршруты и матчи чаще будут срываться.",
  "info.note3":
    "Если игра уже была запущена в момент блокировки, она останется на прежнем реле. Блокировка сработает только после перезапуска игры.",
  "info.note4":
    "Каждое правило привязано к файлу игры. После переноса или переустановки старые правила указывают в пустоту — программа предупредит и перезапишет их одной кнопкой.",
  "info.note5":
    "Блокируются реле, а не сами игровые серверы. В редких случаях сеть всё же направит вас в заблокированный регион.",
  "info.shareTitle": "Профили и обмен",
  "info.shareBody":
    "Выбор можно назвать и сохранить как профиль справа. Значок обмена даёт код для передачи другим — в нём только выбор серверов и профили, без путей с вашего компьютера.",
  "info.disclaimer": "Неофициальное приложение. Не связано с Valve.",
  ...
  "active.otherGames": "Также заблокировано: {games}",
  "active.persistHint":
    "Эти правила действуют и при закрытом server2pick. Они сохраняются, пока вы не снимете их здесь.",
  "active.unblock": "Снять блокировки",
  "active.keep": "Продолжить настройку",

  "close.title": "Правила останутся активными",
  "close.body":
    "Сейчас установлено правил: {count}. Они продолжат действовать после закрытия программы.",
  "close.keep": "Оставить и выйти",
  "close.remove": "Удалить и выйти",
  "close.needsAdmin":
    "Для удаления нужны права администратора. Перезапустите от имени администратора или оставьте правила.",
  "close.cancel": "Отмена",
